...
INSERT INTO `city` (id, name, country_id) VALUES (1,'Maryland',1),(2,'C',1),(3,'Vancouver',1),(4,'Ottawa',1),(5,'Calgary',1),(6,'Edmonton',1),(7,'Quebec City',1),(8,'Winnipeg',1),(9,'Hamilton',1),(10,'Kitchener',1);
...
INSERT INTO `thesis` (id, application_date, defense_date, description, name, grade, url, mentor_id, student_id) VALUES (1,'2021-06-01','2021-06-25','Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae quia commodi alias impedit obcaecati quasi facilis eum fugit dicta, voluptatum in molestiae accusantium, minus nam qui quos minima pariatur laborum. Aut voluptatum, culpa quae rerum a sequi velit quisquam beatae praesentium! Tempora, sapiente sed earum quia numquam placeat sequi expedita!','Specification and implementation of social network web application - \"Facebok\"',10,'https://www.umd.ca/thesis/social-network-facebook',11,41);
